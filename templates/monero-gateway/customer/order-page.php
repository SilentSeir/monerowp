<section class="woocommerce-order-details">
    ...
    <strong id="haven_payment_messages">

        <span class="haven_payment_unpaid">Please pay the amount due to complete your transactions. Your order will expire in <span class="haven_payment_expire_time"></span> if payment is not received.</span>

        <span class="haven_payment_partial">We have received partial payment. Please pay the remaining amount to complete your transactions. Your order will expire in <span class="haven_payment_expire_time"></span> if payment is not received.</span>

        <span class="haven_payment_paid">We have received your payment in full. Please wait while amount is confirmed. Approximate confirm time is <span class="haven_confirm_time"></span>. <?php if(is_wc_endpoint_url('order-received')): ?><br/>You can <a href="<?php echo $details['my_order_url']; ?>">check your payment status</a> anytime in your account dashboard.<?php endif; ?></span>

        <span class="haven_payment_confirmed">Your order has been confirmed. Thank you for paying with Haven!</span>

        <span class="haven_payment_expired">Your order has expired. Please place another order to complete your purchase.</span>

        <span class="haven_payment_expired_partial">Your order has expired. Please contact the store owner to receive refund on your partial payment.</span>
    ...
    <ul class="order_details" style="margin-top:30px">
        <li>
            ...
            <strong class="haven_details_row">
                <span class="haven_details_main" id="haven_integrated_address"></span>
                <span class="haven_details_right button-row">
                    <?php if($show_qr): ?>
                    <button href="#" class="button" title="Show QR Code" onclick="haven_showQR()">
                    ...
                    <button href="#" class="button clipboard" title="Copy Address"
                            data-clipboard-target="#haven_integrated_address">
        ...
        <li>
            Total due:
            <strong class="have_details_row">
                <span class="haven_details_main">
                    <span id="haven_total_due"></span> XHV
                </span>
                <span class="haven_details_right button-row">
                    <button href="#" class="button clipboard" title="Copy Amount"
                            data-clipboard-target="#haven_total_due">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512" version="1"><path d="M504 118c-6-6-12-8-20-8H365c-11 0-23 3-36 11V27c0-7-3-14-8-19s-12-8-20-8H183c-8 0-16 2-25 6-10 4-17 8-22 13L19 136c-5 5-9 12-13 22-4 9-6 17-6 25v192c0 7 3 14 8 19s12 8 19 8h156v82c0 8 2 14 8 20 5 5 12 8 19 8h274c8 0 14-3 20-8 5-6 8-12 8-20V137c0-8-3-14-8-19zm-175 52v86h-85l85-86zM146 61v85H61l85-85zm56 185c-5 5-10 12-14 21-3 9-5 18-5 25v73H37V183h118c8 0 14-3 20-8 5-6 8-12 8-20V37h109v118l-90 91zm273 229H219V292h119c8 0 14-2 19-8 6-5 8-11 8-19V146h110v329z"/></svg>
                    </button>
                </span>
            </strong>
        ...
        <li style="display:none">
            Total order amount:
            <strong>
                <span id="haven_total_amount"></span> XHV
            </strong>
        </li>
        <li>
            Total paid:
            <strong>
                <span id="haven_total_paid"></span> XMR
            </strong>
        </li>
        <li>
            Exchange rate:<strong id="haven_exchange_rate"></strong>
        </li>
    </ul>



    <table id="haven_tx_table" style="display:none;">
        <thead>
            <tr>
    ...
    <div id="haven_tx_none" style="display:none;">
    </div>

    <div id="haven_qr_code_container" style="display:none;" onclick="haven_showQR(false)">
        <div id="haven_qr_code">
        </div>
    </div>

</section>

<div id="haven_toast"></div>
